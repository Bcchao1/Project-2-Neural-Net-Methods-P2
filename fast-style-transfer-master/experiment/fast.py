...
def get_args():
    ...
    parser.add_argument('--style', default=20, type=float,
                        help='Style weight')
    parser.add_argument('--content', default=13, type=float,
                        help='Content weight')
    parser.add_argument('--tv', default=1e-4, type=float,
                        help='TV weight')

    parser.add_argument('--styleim', default='pizza.jpg', type=str,
                        help='Style image name')
    parser.add_argument('--loadstyle', default='pizza_step_18', type=str,
                        help='Load pretrained style transfer model')
    parser.add_argument('--input_path', default='../data/penguin.jpg', type=str,
